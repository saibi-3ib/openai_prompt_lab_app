...
def upgrade():
    ...
    op.create_table('stock_ticker_map',
    ...
    with op.batch_alter_table('stock_ticker_map', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_stock_ticker_map_company_name'), ['company_name'], unique=False)
        batch_op.create_index(batch_op.f('ix_stock_ticker_map_gics_sector'), ['gics_sector'], unique=False)
    ...
    with op.batch_alter_table('target_accounts', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_target_accounts_provider'), ['provider'], unique=False)
        batch_op.create_index(batch_op.f('ix_target_accounts_username'), ['username'], unique=True)
    ...
    with op.batch_alter_table('analysis_results', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_analysis_results_extracted_tickers'), ['extracted_tickers'], unique=False)
        batch_op.create_index(batch_op.f('ix_analysis_results_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_analysis_results_prompt_id'), ['prompt_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['username'], ['target_accounts.username'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('collected_posts', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_collected_posts_post_id'), ['post_id'], unique=True)
        batch_op.create_index(batch_op.f('ix_collected_posts_username'), ['username'], unique=False)

    op.create_table('user_ticker_weights',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['ticker'], ['stock_ticker_map.ticker'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    with op.batch_alter_table('user_ticker_weights', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_ticker_weights_account_id'), ['account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_user_ticker_weights_ticker'), ['ticker'], unique=False)
        batch_op.create_index(batch_op.f('ix_user_ticker_weights_weight_ratio'), ['weight_ratio'], unique=False)

    op.create_table('analysis_posts_link',
    ...
    sa.ForeignKeyConstraint(['collected_post_id'], ['collected_posts.id'], ),
    sa.PrimaryKeyConstraint('analysis_result_id', 'collected_post_id')
    )
    op.create_table('ticker_sentiment',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('analysis_result_id', sa.Integer(), nullable=False),
    sa.Column('collected_post_id', sa.Integer(), nullable=False),
    sa.Column('ticker', sa.String(length=10), nullable=False),
    ...
    with op.batch_alter_table('ticker_sentiment', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ticker_sentiment_analysis_result_id'), ['analysis_result_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ticker_sentiment_collected_post_id'), ['collected_post_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ticker_sentiment_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_ticker_sentiment_ticker'), ['ticker'], unique=False)
